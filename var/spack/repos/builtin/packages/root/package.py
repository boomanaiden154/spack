...
class Root(CMakePackage):
    ...
    conflicts("^intel-tbb@2021.1:", when="@:6.22", msg="Please use an older intel-tbb version for ROOT")
    conflicts(
    ...
    conflicts("cxxstd=20", when="@:6.28.02", msg="C++20 support requires root version at least 6.28.04")
